...
void sorted_vector_t::create_vector_sentinel(int l, int r, vector<int>& v) //el centinela le da a la ultima posición de cada vector un tamaño mas grande que a cualquiera(infinito) para que cuando ordene los ordene de mayor a menor correctamente
