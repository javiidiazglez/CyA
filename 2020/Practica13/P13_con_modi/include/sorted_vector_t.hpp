...
class sorted_vector_t: public vector<string>
{
public:
    sorted_vector_t(void):
    vector<string>() {} //constructor por defecto

    sorted_vector_t(const vector<string>& v): //constructor
    vector<string>(v) {}
...
private:
    ...
    void create_vector_sentinel(int l, int r, vector<string>& v); //método para añadir el centinela
    void merge(const vector<string>& v1, const vector<string>& v2, int l); //método para dividir en 2 vectores mas pequeños
